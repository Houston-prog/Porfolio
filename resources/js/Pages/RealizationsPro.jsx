...
export default function RealizationsPro() {
    return (
        <AuthenticatedLayout
            header={
        ...
        >
            <Head title="Admin - Réalisations Pro" />
                    ...
                    <div className="max-w-5xl">
                        <div className="bg-[var(--bg-secondary)] border border-[var(--border)] rounded-xl p-8 shadow-2xl text-white">
                            <div className="flex justify-between items-center mb-8">
                                <h3 className="text-2xl font-['Archivo_Black']">Projets Professionnels</h3>
                                <button className="bg-[var(--accent-2)] text-white px-4 py-2 rounded-lg font-bold hover:scale-105 transition-transform">
                                    + Nouveau Projet
                                </button>
                            </div>
                            <p className="text-[var(--text-secondary)]">Gérez vos réalisations techniques et expériences professionnelles.</p>
                        </div>
                    </div>
                </main>
            </div>
