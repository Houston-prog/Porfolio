                    ...
                    <div className="max-w-5xl">
                        <div className="bg-[var(--bg-secondary)] border border-[var(--border)] rounded-xl p-8 shadow-2xl text-white">
                            <div className="flex justify-between items-center mb-8">
                                <h3 className="text-2xl font-['Archivo_Black']">Mes Compétences Techniques</h3>
                                <button className="bg-[var(--accent-1)] text-[var(--bg-primary)] px-4 py-2 rounded-lg font-bold hover:scale-105 transition-transform">
                                    + Ajouter une compétence
                                </button>
                            </div>
                            <p className="text-[var(--text-secondary)]">Interface de gestion pour ajouter ou modifier vos stacks techniques.</p>
                        </div>
                    </div>
                </main>
            </div>
